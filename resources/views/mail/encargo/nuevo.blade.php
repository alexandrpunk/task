...
<p style='font-size:1.2rem;text-align:center;'>
    El usuario <b>{{$encargo->asignador->nombre.' '.$encargo->asignador->apellido}}</b> te ha pedido el siguiente encargo:
</p>
<div style='font-size:1.5rem;background-color:#E8E8E8;border-radius:4px;padding:10px;text-align:center;margin:0 10%;'>
    ...
    <p style='font-size:1rem;font-weight:bolder;color:#545454;'>
        Con plazo de cumplimiento para: {{strftime('%A %d de %B %Y',strtotime($encargo->fecha_plazo->getTimestamp()))}}
    </p>
</div>
