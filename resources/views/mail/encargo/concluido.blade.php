...
<h1 style='text-align:center;font-weight:300;font-size:2.8rem;margin:10px'>
   {{$encargo->responsable->nombre.' '.$encargo->responsable->apellido}} ha conclido tu encargo
</h1>
...
<p style='font-size:1.2rem;text-align:center;'>
    El usuario <b>{{$encargo->responsable->nombre.' '.$encargo->responsable->apellido}}</b> ha concluido tu encargo:
</p>
...
<p style='font-size:1.2rem;text-align:center;'>
    Te sugerimos ver el encargo para conocer todos sus detalles.
</p>
