<div class="list-group" role='list'>
    ...
    <div class="list-group-item contacto row mx-0">
        ...
        <div class="col-12 col-sm align-self-center">
            ...
            <span class='email'><i class="fa fa-envelope fa-fw" aria-hidden="true"></i> {{$contacto->contacto->email}}</span>
            <span class='telefono'><i class="fa fa-phone fa-fw" aria-hidden="true"></i> {{$contacto->contacto->telefono}}</span>
        </div>
        <div class="col-12 col-sm-auto align-self-center px-0 text-center">
            <div class="align-self-baseline">
                <a href="{{route('encargos_contacto', ['id' => $contacto->contacto->id])}}" class="btn btn-sm btn-default text-info d-inline-block d-sm-block">
